...
export default async function CarsPage() {
  ...
  return <>
    ...
    <section className="section" data-reveal><div className="shell"><Fleet photos={fleetPhotos} /><p className="fine-print">* Fleet and rates shown are launch estimates. Final car, included kilometres and price are confirmed before booking.</p></div></section>
    ...
    <HowItWorks />
    <BookingSection title="Found the one? Book directly." copy="Select your dates and preferred car. We will save your booking and confirm on WhatsApp with zero advance online." />
    <FinalCta />
  </>;
}
