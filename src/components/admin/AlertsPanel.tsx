...
export function AlertsPanel({ alerts }: { alerts: Alerts }) {
  const total = alerts.documents.length + alerts.overdue.length + alerts.unassigned.length + alerts.staleEnquiries.length + alerts.conflicts.length + alerts.checklist.length + alerts.overduePurges.length;
