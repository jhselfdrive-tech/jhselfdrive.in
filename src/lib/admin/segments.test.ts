...
const base = { completed_booking_count: 0, booking_count: 0, last_seen_at: "2026-09-01T00:00:00Z" };
...
describe("deriveSegments", () => {
  ...
  it("marks a request with no completed rental hot", () => expect(deriveSegments({ ...base, booking_count: 1 }, now)).toEqual(["hot_lead"]));
  it("marks repeat requests with no completed rental hot", () => expect(deriveSegments({ ...base, booking_count: 3 }, now)).toEqual(["hot_lead"]));
